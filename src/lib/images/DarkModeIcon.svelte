<script lang="ts">
    export let widthSvg = 30;
</script>

<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" width={widthSvg} viewBox="0 0 256 256" xml:space="preserve">
